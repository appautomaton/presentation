...
## Case 1: Service Model Reform (BCG Australia Post)
...
## Case 2: Pricing Review (McKinsey NDIS Australia)
...
## Case 3: Sector Decarbonization (BCG New Zealand Electricity)
...
## Case 4: Organizational Restructuring (Bain SARS South Africa)
...
**Recommendation:** Do not proceed until the blind spot is resolved. Add a kill condition: "Does the proposed structure preserve end-to-end case management visibility for complex matters?" If no, redesign to maintain integrated case teams within the functional model. Additionally: the diagnostic consulted 33 people out of 14,000 staff over 6 days, an inadequate evidence base for a $200M restructuring. Confidence: Low on proceeding (blind spot unresolved). Key risk: restructuring without E2E visibility testing will fragment case management, the exact failure mode observed in the real outcome.
...
For the full synthesis methodology, see [frameworks.md §3](../references/method/frameworks.md).
