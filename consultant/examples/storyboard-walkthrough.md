...
**Client**: MedTech Corp ($200M medical devices, US-dominant)
**Question**: Should we enter the European market, and if so, how?
**Governing thought**: MedTech should acquire EuroDistributor for $45M to enter Europe and achieve $100M in European revenue within 5 years.
...
- **Data:**
  ...
  | Tax impact | -8 |
  | **Net value created** | **+60** |
```

**What consultant provides vs. what the delivery skill decides:**
