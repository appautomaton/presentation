...
| Hex | Token | L | Use |
|---|---|---|---|
| `#0A0E14` | Midnight | 5% | Cover and divider backgrounds |
| `#123A63` | Navy | 25% | Header bar, action titles, chart bars |
| `#C7D5E5` | Structure | 80% | Panel borders, gridlines, evidence block strokes |
| `#E4EDF7` | Mist | 92% | Evidence fills, card backgrounds |
| `#F3F6FA` | Canvas | 97% | Default slide background |

## Text

| Hex | Token | L | Use |
|---|---|---|---|
| `#101A27` | Text | 10% | Body copy, headlines on light surfaces |
| `#4E6176` | Gray | 40% | Secondary text, annotations, axis labels |
| `#71859A` | Fine | 55% | Footnotes, source lines |

## Text Pairing

- On Canvas or white: Navy headlines, Text body.
- On Midnight: `#FFFFFF` first, Structure second.
