...
**Negative:**
```
"[Company]'s historical growth engines are structurally decelerating. Without a
 portfolio shift, organic revenue will decline [X]% over [timeframe].
 The priority is [harvest/restructure/divest] to preserve $[Y]M in value."
```
...
|---|--------|-------------|----------------|----------------|
| 1 | **Growth Diagnostic** | Where has growth come from? | GGD: Portfolio Momentum + M&A + Share Gain | Pivot → "past was X, future requires Y" |
| 2 | **Vector Identification** | Where are the opportunities? | Ansoff Matrix or Three Horizons screen | Narrowing → "of N vectors, M survive" |
...
- [ ] GGD components sum to total CAGR (arithmetic check)
- [ ] ≥1 vector is NOT an extrapolation of historical growth
- [ ] Each vector sized with TAM → SAM → capture rate chain
- [ ] Reallocation + incremental investment covers ≥80% of growth investment
- [ ] Phasing benchmarked against comparable growth programs
- [ ] Competitive window justified by specific time-bound trigger
- [ ] Title chain (slides 3, 8, 14, 20) tells complete story
