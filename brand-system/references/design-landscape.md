...
- **Surface**: off-white (`#F8F9FA`) with subtle surface-muted zones for cards and panels
- **Typography**: geometric sans-serif, two weights visible (semibold titles, regular body). Slightly larger metrics.
...
- **Surface**: deep charcoal or near-black (`#0A0E14`) with electric accent pops
- **Typography**: bold sans-serif headings (often oversized, 44-60px). Regular weight body in light gray.
